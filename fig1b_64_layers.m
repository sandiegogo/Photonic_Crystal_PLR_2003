...
clc;
clear;
fid = fopen('fig1b_64_layers.txt','w');

n1 = 1;
n2 = 65; % unit cells's number is 16, why here is 33? why not 32? 
f1 = 1;
f2 = 50;
nf = 500;
fstep = (f2-f1)/nf;
...
%draw pictures
scatter(t^2,f,'filled')%why can't I draw? but I can draw the data with ORIGIN. 
